...
export default function ChangePasswordScreen() {
  ...
  const handleSubmit = async () => {
    ...
    const temp = {
      ...
      try {
        const result = await axios.post(`http://` + ip + `/forgotpassword/changepassword`, temp, {
          headers: {
        ...
        <Form
          ...
          <YStack alignItems="center" space="$2" style={styles.xstackl}>
            ...
            <XStack alignItems="center" space="$2" style={styles.xstack}>
              ...
              <Input flex={1} placeholder="Password" keyboardType="default" onChangeText={(newText) => setPassword(newText)}/>
            </XStack>
          </YStack>
